            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/auth.ResetPasswordResponseDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/profile.ProfileResponseDTO"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/profile.UpdateProfileDTO"
                        }
                    }
                ],
                "responses": {
        ...
        "user.CreateUserDTO": {
            ...
            "properties": {
                ...
                "status": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/shared.UserStatus"
                        }
                    ]
                }
            }
